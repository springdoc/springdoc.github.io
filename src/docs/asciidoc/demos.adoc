...
* link:https://github.com/springdoc/springdoc-openapi-demos/tree/master/demo-microservices[Demo Spring Boot 4 and Spring Cloud Gateway (source code), window="_blank"]
