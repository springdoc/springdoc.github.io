...
- link:https://github.com/springdoc/springdoc-openapi/blob/master/springdoc-openapi-starter-webflux-api/src/test/java/test/org/springdoc/api/v31/app90/HelloRouter.java[HelloRouter]
- link:https://github.com/springdoc/springdoc-openapi/blob/master/springdoc-openapi-starter-webflux-api/src/test/java/test/org/springdoc/api/v31/app90/quotes/QuotesRouter.java[QuotesRouter]
- link:https://github.com/springdoc/springdoc-openapi/blob/master/springdoc-openapi-starter-webflux-api/src/test/java/test/org/springdoc/api/v31/app90/book/BookRouter.java[BookRouter]
- link:https://github.com/springdoc/springdoc-openapi/blob/master/springdoc-openapi-starter-webflux-api/src/test/java/test/org/springdoc/api/v31/app90/employee/EmployeeRouter.java[EmployeeRouter]
- link:https://github.com/springdoc/springdoc-openapi/blob/master/springdoc-openapi-starter-webflux-api/src/test/java/test/org/springdoc/api/v31/app90/position/PositionRouter.java[PositionRouter]
...
`springdoc-openapi` provides built-in support for the link:https://modelcontextprotocol.io/[Model Context Protocol (MCP), window="_blank"], enabling your REST API endpoints to be automatically discovered and used as tools by AI agents.
...
Your `@RestController` endpoints are now available as MCP tools. For detailed configuration, extension points, guardrails, and dashboard usage, see the <<mcp>> section.
