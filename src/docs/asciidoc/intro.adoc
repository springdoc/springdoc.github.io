...
[link=https://www.youtube.com/watch?v=nfIcjkR4KZ8,window=_blank]
image::img/spring-io-26.webp[springdoc-openapi talk at the Spring I/O 2026 conference,1200,702]
