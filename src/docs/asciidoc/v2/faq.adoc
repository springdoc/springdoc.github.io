...
* For a project that uses `spring-security`, you should add the following dependency, in combination with the `springdoc-openapi-starter-webmvc-ui` dependency:
